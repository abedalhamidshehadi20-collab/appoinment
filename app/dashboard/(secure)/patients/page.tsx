  ...
  return (
    <>
      <article className="card p-6">
        ...
        <div className="mt-4">
          <PatientWithAppointmentForm doctors={data.projects} />
        </div>
      </article>
        ...
        data.patients.map((patient) => (
          <article key={patient.id} className="card p-6">
              ...
              <div>
                ...
                {patient.medicalHistory && (
                  <p className="mt-2 text-sm">
                    <span className="font-semibold">Medical History:</span> {patient.medicalHistory}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="mt-5">
              ...
              <AppointmentForm patientId={patient.id} doctors={data.projects} />
            </div>
